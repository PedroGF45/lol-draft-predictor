...
class MasterDataRegistry:
    ...
    def register_matches(self, matches_df: pd.DataFrame, collection_metadata: Optional[Dict] = None) -> Tuple[pd.DataFrame, int]:
        """
    ...
    def filter_new_matches(self, match_ids: List[str], game_versions: Optional[List[str]] = None) -> List[Tuple[str, str]]:
        """
    ...
    def __repr__(self) -> str:
        ...
        return (f"MasterDataRegistry(total={len(self.match_registry)}, "
